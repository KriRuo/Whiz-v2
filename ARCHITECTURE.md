...
- [CHANGES_DOCUMENTATION.md](./CHANGES_DOCUMENTATION.md) - Recent changes and improvements
- [WAVEFORM_ANIMATION_IMPLEMENTATION.md](./WAVEFORM_ANIMATION_IMPLEMENTATION.md) - Waveform details
- [CUSTOM_TITLEBAR_README.md](./CUSTOM_TITLEBAR_README.md) - Title bar implementation
